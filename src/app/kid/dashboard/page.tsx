...
export default async function KidDashboard() {
    ...
    return (
        <div className="space-y-10 pb-20">
            {/* Hero Section */}
            <div className="relative overflow-hidden rounded-[3rem] bg-gradient-to-r from-kid-blue via-blue-400 to-kid-purple p-8 md:p-12 text-white shadow-xl">
                <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-12">
                    <div className="relative group perspective-1000">
                        <div className="w-32 h-32 md:w-48 md:h-48 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center border-4 border-white/30 shadow-2xl transition-transform duration-500 group-hover:rotate-y-12 group-hover:scale-105">
                            <Image
                        ...
                        <div className="absolute -bottom-2 -right-2 bg-yellow-400 text-yellow-900 border-4 border-white rounded-full p-2 shadow-lg animate-bounce">
                ...
                {activities.map((activity, index) => {
                    ...
                    return (
                        <Link
                            ...
                            href={activity.href}
                            className={cn(
                                "group relative overflow-hidden rounded-[2.5rem] p-8 transition-all duration-500 hover:scale-[1.03] hover:-translate-y-2 focus:outline-none focus:ring-4 focus:ring-offset-4 ring-offset-kid-bg",
                                "bg-white border-2 border-transparent hover:border-white/50 shadow-lg hover:shadow-2xl",
                                activity.shadow
                            )}
                        >
                            <div className={cn(
                            ...
                            <div className="relative z-10 flex items-start gap-6">
                                <div className={cn(
                                    "w-20 h-20 rounded-[1.5rem] flex items-center justify-center text-white shadow-lg transform transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110 bg-gradient-to-br",
                                    activity.color
                                )}>
                                ...
                                <div className="flex-1 pt-2">
                                    ...
                                    <p className="text-lg font-medium text-slate-500 group-hover:text-slate-700 transition-colors">
                                        {activity.description}
                                    </p>
                                </div>
                            </div>

                            <div className="absolute right-4 bottom-4 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-4 group-hover:translate-x-0">
                ...
                <div className="flex flex-wrap gap-4">
                    {[
                        ...
                        <Link
                            ...
                            className={cn(
                                "px-6 py-3 rounded-full text-lg font-bold border-2 transition-all duration-300 transform hover:scale-110 shadow-sm hover:shadow-md",
                                topic.color
                            )}
                        >
                            {topic.label}
